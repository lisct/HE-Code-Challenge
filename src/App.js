            ...
            <div className="form__container">
              <div className="form__input-container">
                <div className="form__input-items">
                  <label className="form__input-label" forhtml="username">
                    Name
              ...
              <div className="form__input-container">
                ...
                <div className="form__input-items">
                  <label className="form__input-label" forhtml="password">
                    Password
                    <abbr title="required">*</abbr>
                  </label>
                  <input
              ...
              <div className="form__input-container">
                ...
                <div className="form__inline">
                  <div className="form__input-items">
                    <label className="form__input-label-rc" forhtml="male">
                      male
                      <input
                  ...
                  <div className="form__input-items">
                    <label className="form__input-label-rc" forhtml="female">
                      female
                      <input
                        className="form__input-radio"
                        id="female"
                  ...
                  <div className="form__input-items">
                    <label className="form__input-label-rc" forhtml="other">
                      other
                      <input
                        className="form__input-radio"
                        id="other"
